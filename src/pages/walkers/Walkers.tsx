  ...
  return (
    <IonPage>
      ...
      <IonContent fullscreen className="ion-padding">
          ...
          <WalkerCard name="Johnatan Stephen Doesohn" price={34} rating={4} photo={'https://images.unsplash.com/photo-1599566150163-29194dcaad36?q=80&w=3774&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'} distance={2}></WalkerCard>
          ...
          <WalkerCard name="Sophie June" price={5326} rating={3.8} photo={'https://plus.unsplash.com/premium_photo-1675034377239-a839117fe934?q=80&w=3064&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'} distance={6}></WalkerCard>

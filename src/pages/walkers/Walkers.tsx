  ...
  return (
    <IonPage>
      ...
      <IonContent fullscreen className="ion-padding">
        ...
        <WalkerCard name="Lorem Ipsum" price={50} rating={3.9} photo={'https://images.unsplash.com/photo-1527980965255-d3b416303d12?q=80&w=3023&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'} distance={4.2} openProfile={() => setIsOpen(true)}></WalkerCard>
        ...
        <IonModal isOpen={isOpen}>
          ...
          <IonContent className="ion-padding">
            <WalkerProfile
            photo={'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=3870&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'}
            ></WalkerProfile>
          </IonContent>
        </IonModal>
      </IonContent>
